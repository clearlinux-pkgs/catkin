...
Version  : 0.7.17
Release  : 29
URL      : https://github.com/ros/catkin/archive/0.7.17/catkin-0.7.17.tar.gz
Source0  : https://github.com/ros/catkin/archive/0.7.17/catkin-0.7.17.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1555166066
mkdir -p clr-build
pushd clr-build
