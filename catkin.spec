...
Version  : 0.7.19
Release  : 32
URL      : https://github.com/ros/catkin/archive/0.7.19/catkin-0.7.19.tar.gz
Source0  : https://github.com/ros/catkin/archive/0.7.19/catkin-0.7.19.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570558560
mkdir -p clr-build
pushd clr-build
...
cp LICENSE %{buildroot}/usr/share/package-licenses/catkin/LICENSE
pushd clr-build
%make_install
popd
...
/usr/share/package-licenses/catkin/LICENSE
