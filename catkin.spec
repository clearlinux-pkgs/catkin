...
Source0  : https://github.com/ros/catkin/archive/0.8.7/catkin-0.8.7.tar.gz
...
%prep
%setup -q -n catkin-0.8.7
cd %{_builddir}/catkin-0.8.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594822363
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/catkin-0.8.7/LICENSE %{buildroot}/usr/share/package-licenses/catkin/8a5f2893445b1f334b6c2554e38bf39f4ab70913
pushd clr-build
%make_install
popd
