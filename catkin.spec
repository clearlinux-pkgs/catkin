...
Version  : 0.7.16
Release  : 27
URL      : https://github.com/ros/catkin/archive/0.7.16.tar.gz
Source0  : https://github.com/ros/catkin/archive/0.7.16.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552579987
mkdir -p clr-build
pushd clr-build
