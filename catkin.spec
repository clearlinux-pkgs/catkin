...
Version  : 0.7.6
Release  : 5
URL      : https://github.com/ros/catkin/archive/0.7.6.tar.gz
Source0  : https://github.com/ros/catkin/archive/0.7.6.tar.gz
...
%prep
%setup -q -n catkin-0.7.6

%build
export LANG=C
export SOURCE_DATE_EPOCH=1487703758
mkdir clr-build
pushd clr-build
cmake .. -G "Unix Makefiles" -DCMAKE_INSTALL_PREFIX=/usr -DBUILD_SHARED_LIBS:BOOL=ON -DLIB_INSTALL_DIR:PATH=%{_libdir} -DCMAKE_AR=/usr/bin/gcc-ar -DLIB_SUFFIX=64 -DCMAKE_BUILD_TYPE=RelWithDebInfo -DCMAKE_RANLIB=/usr/bin/gcc-ranlib -DCATKIN_BUILD_BINARY_PACKAGE=TRUE
...
/usr/share/catkin/cmake/interrogate_setup_dot_py.pyo
...
/usr/share/catkin/cmake/test/download_checkmd5.pyo
...
/usr/share/catkin/cmake/test/remove_test_results.pyo
/usr/share/catkin/cmake/test/run_tests.py
/usr/share/catkin/cmake/test/run_tests.pyc
/usr/share/catkin/cmake/test/run_tests.pyo
